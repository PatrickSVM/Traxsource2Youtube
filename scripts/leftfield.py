...
if __name__ == "__main__":
    url = "https://www.traxsource.com/genre/14/leftfield"
    name = "Leftfield - Top 10 Charts on Traxsource"
    desc = "Playlist with the latest Leftfield - Top 10 Charts on Traxsource"
